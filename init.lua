...
local function get_animation_speed(player)
	...
	local speed = sneak and ANIMATION_SPEED_SNEAK or ANIMATION_SPEED
	return speed
end
...
local ANIMATIONS = {
	...
	[LAY] = function(player, _time)
		...
		local body_position = {x = 0,   y = -5, z = 0}
		local body_rotation = {x = 270, y = 0,  z = 0}
		rotate_bone(player, BODY, body_rotation, body_position)
	end,
	...
	[SIT] = function(player, _time)
		...
		local body_position = {x = 0, y = -5, z = 0}
		local body_rotation = {x = 0, y = 0,  z = 0}
		rotate_bone(player, BODY, body_rotation, body_position)
	end,
...
local player_api_get_animation = player_api.get_animation
local function animate_player(player, dtime)
	local animation = player_api_get_animation(player).animation
